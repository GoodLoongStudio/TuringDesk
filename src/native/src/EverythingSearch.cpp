...
EverythingSearch::EverythingSearch() : state_(std::make_shared<SharedState>()) {}

std::wstring EverythingSearch::FindClientBinary() {
...
bool EverythingSearch::PipeAvailable() {
...
bool EverythingSearch::Query(HWND replyWindow, const std::wstring& query, DWORD maxResults) const {
    ...
    std::thread([state, generation, binary, replyWindow, query, maxResults]() {
        ...
        copyData.dwData = EverythingSearch::kReplyId;
